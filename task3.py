...
class1 = int(input('Введите кол-во учеников 1 класса: '))
class2 = int(input('Введите кол-во учеников 2 класса: '))
class3 = int(input('Введите кол-во учеников 3 класса: '))
sum = (class1+1)//2 + (class2 +1)//2 + (class3+1)//2
print(f'Минимальное количество парт для учеников равно: {sum}')